                        ...
                        <div class="col-md-55" data-id="{{$image->id}}" id="image-{{$image->id}}">
                            <div class="thumbnail">
                                <div class="image view view-first">
                                    <img style="width: 100%; display: block;" src="{{asset('images/slider/mid/'.$image->file_path)}}" alt="image" />
                                    <div class="mask">
                                        <p>&nbsp</p>
                                        <div class="tools tools-bottom">
                                            <a href="#!" data-id="{{$image->id}}" class="delete_image_mid"><i class="fa fa-times"></i></a>
                                        </div>
                                    </div>
                                </div>
